...
public class CargoShipFrontModeEasy extends AutoModeBase {
    ...
    public CargoShipFrontModeEasy(boolean driveToLeftCargo) {
        ...
        if(mStartedLeft) {
            ...
            mLevel1ToCargoOneLineupForward = new DriveTrajectory(mTrajectoryGenerator.getTrajectorySet().levelOneToCargoOneLineupForwardLeft, true, false, TrajectoryGenerator.kCargoOneLineupPoseLeft.getTranslation().translateBy(new Translation2d(-4.0, -4.0)), TrajectoryGenerator.kCargoOneLineupPoseLeft.getTranslation().translateBy(new Translation2d(4.0, 4.0)), false);
