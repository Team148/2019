...
public class Constants {
    ...
    public static final double ELEVATOR_F_DOWN = ELEVATOR_F_UP + 0.03 + 0.1;
    ...
    public static final double ELEVATOR_MIDDLE = 21000;
    public static final double ELEVATOR_HIGH = 41000;
    public static final double ELEVATOR_MAX_HEIGHT = 45000;
